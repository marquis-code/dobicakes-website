<template>
 ...
 <div class="space-y-2">
 <h3 class="text-lg tracking-tight text-brand-charcoal ">{{ alertConfig.title }}</h3>
 ...
 <button 
 @click="onConfirm" 
 class="w-full py-4 bg-brand-charcoal text-white text-sm font-bold tracking-[0.3em] hover:bg-brand-gold transition-all duration-500 shadow-lg"
 >
 ...
 @click="onCancel" 
 class="w-full py-4 border border-gray-100 text-brand-muted text-sm font-bold tracking-[0.3em] hover:bg-gray-50 transition-all duration-500"
 >
