<template>
 ...
 <span class="text-brand-gold text-sm font-bold ">The Boutique</span>
 <h1 class="text-5xl md:text-7xl text-white tracking-tight">Our Collection</h1>
 <p class="text-xs text-gray-50 tracking-widest max-w-lg mx-auto">Discover our handcrafted selection of premium cakes, each made with the finest ingredients.</p>
 </div>
 </div>
 ...
 <div class="flex flex-col lg:flex-row gap-16">
  <!-- Sidebar Filters -->
  <aside class="w-full lg:w-56 shrink-0 space-y-10 lg:sticky lg:top-32 lg:self-start">
 <div>
 <h4 class="text-sm font-bold tracking-[0.3em] mb-6 text-brand-charcoal">Categories</h4>
 <ul class="space-y-3">
 <li v-for="cat in categories" :key="cat" 
 @click="selectedCategory = cat"
 :class="selectedCategory === cat ? 'text-brand-gold font-bold' : 'text-brand-muted hover:text-brand-gold'"
 class="text-sm tracking-widest cursor-pointer transition-colors py-1 border-b border-transparent"
 ...
 <!-- Availability Filter -->
 <div>
 <h4 class="text-sm font-bold tracking-[0.3em] mb-6 text-brand-charcoal">Availability</h4>
 <ul class="space-y-3">
 ...
 class="text-sm tracking-widest cursor-pointer transition-colors py-1">
 {{ avail.label }}
 </li>
 </ul>
 </div>
 ...
 <p class="text-sm tracking-[0.3em] text-brand-muted">Showing {{ sortedProducts.length }} creations</p>
 </div>
 ...
 <p class="text-brand-muted text-sm tracking-widest">No creations found matching your criteria.</p>
 <button @click="selectedCategory = 'All'; selectedAvailability = 'all'" class="text-sm font-bold tracking-widest text-brand-gold hover:text-brand-charcoal transition-colors">
 Clear Filters
 </button>
 </div>
 </div>
