<template>
 ...
 <p class="text-sm text-brand-muted tracking-widest">You don't need an account to place an order.</p>
 </div>
 ...
 <div class="space-y-6">
 <h2 class="text-2xl text-brand-charcoal tracking-widest">Delivery Information</h2>
 ...
 <h2 class="text-2xl text-brand-charcoal">Payment Method</h2>
 ...
 <h3 class="text-3xl text-brand-charcoal">Login</h3>
 ...
 <button @click.prevent="showPassword = !showPassword" type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-900 hover:text-brand-gold transition-colors">
...
const { login, firebaseLogin: socialLogin, user, isAuthenticated: isLoggedIn } = useAuth();
