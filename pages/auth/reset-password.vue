  ...
  <div class="min-h-screen bg-brand-cream/20 flex flex-col items-center justify-center p-6">
    <div class="w-full max-w-md bg-white p-12 shadow-[0_40px_100px_rgba(0,0,0,0.05)] border border-gray-50 space-y-10 animate-fade-in">
      <div class="text-center space-y-4">
        ...
        <h1 class="text-3xl font-serif text-brand-charcoal  tracking-tight">Reset Password</h1>
        <p class="text-[10px] text-brand-muted  tracking-[0.3em] font-light">Choose a new secure password for your account</p>
      </div>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-8">
        ...
        >
          ...
          <span class="relative z-10 text-[10px] font-bold  tracking-[0.4em]">{{ loading ? 'Resetting...' : 'Update Password' }}</span>
        </button>
      </form>
    </div>
  </div>
