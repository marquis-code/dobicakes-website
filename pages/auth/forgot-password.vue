<template>
 ...
 <h1 class="text-3xl text-brand-charcoal tracking-tight">Forgotten Password</h1>
 <p class="text-sm text-brand-muted tracking-[0.3em] font-light">Enter your email to receive a secure reset link</p>
 </div>
 ...
 <span class="relative z-10 text-sm font-bold ">{{ loading ? 'Sending link...' : 'Send Reset Link' }}</span>
 </button>
 </form>
