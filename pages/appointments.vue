<template>
 ...
 <div class="space-y-4">
 <span class="text-brand-gold text-sm font-bold ">Bespoke Consultation</span>
 <h1 class="text-5xl md:text-7xl text-brand-charcoal tracking-tight">Book a Private Tasting.</h1>
 ...
 <div>
 <h4 class="text-sm italic text-brand-gold group-hover:translate-x-2 transition-transform">{{ type.name }}</h4>
 <p class="text-sm text-brand-muted tracking-widest">{{ type.duration }} mins • Personalized Session</p>
 </div>
 ...
 <span class="text-sm font-bold tracking-widest ">Automated Sync</span>
 </div>
 ...
 <h3 class="text-xl text-brand-charcoal mb-8">Consultation Details</h3>
 <form @submit.prevent="proceedToPayment" class="space-y-6">
 <div class="space-y-2">
 <label class="text-[9px] font-bold tracking-widest text-gray-800">Full Name</label>
 ...
 <div class="space-y-2">
 <label class="text-[9px] font-bold tracking-widest text-gray-800">Email Address</label>
 ...
 <div class="space-y-2">
 <label class="text-[9px] font-bold tracking-widest text-gray-800">Phone Number</label>
 ...
 <div class="grid grid-cols-2 gap-6">
 <div class="space-y-2">
 <label class="text-[9px] font-bold tracking-widest text-gray-800">Preferred Date</label>
 ...
 <div class="space-y-2">
 <label class="text-[9px] font-bold tracking-widest text-gray-800">Preferred Time</label>
 ...
 <div class="space-y-2">
 <label class="text-[9px] font-bold tracking-widest text-gray-800">Notes (Optional)</label>
 ...
 <button :disabled="loading" class="w-full py-3 bg-brand-charcoal text-white text-sm font-bold transition-all hover:bg-brand-gold">
 ...
 <div class="space-y-2">
 <h3 class="text-2xl text-brand-charcoal">Secure Checkout</h3>
 ...
 <span class="text-sm font-bold tracking-widest ">Total Amount</span>
 <span class="text-2xl text-brand-gold font-bold">₦{{ selectedTypePrice.toLocaleString() }}</span>
 </div>
 <button @click="handlePayment" class="w-full py-3 bg-brand-gold text-white text-sm font-bold transition-all hover:bg-brand-charcoal shadow-xl">
 Pay with Paystack
 </button>
 <button @click="paymentStep = false" class="text-sm font-bold tracking-widest text-gray-800 hover:text-brand-charcoal transition-colors">Go Back</button>
 </div>
 </div>
 </div>
 </div>
